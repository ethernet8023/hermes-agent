...
export const en: Translations = {
  ...
  settings: {
    ...
    sandbox: {
      ...
      description:
        'Supported terminal and file tools run in Windows process containers (MXC). Uncontained tools are refused; host inference and fixed Hermes bookkeeping remain trusted services outside the container.',
      statusAvailable: 'Available',
      statusDegraded: 'Available (limited)',
      statusUnavailable: 'Not available',
      statusUnknown: 'Protection not confirmed. Recheck the backend or turn the sandbox off to recover.',
      modelOutputBlocked: 'Preview withheld under MXC: assistant content cannot read host files, load remote content, or run scripts here.',
      modelOutputUnconfirmed: 'Preview withheld until this content’s owner and sandbox policy are confirmed.',
      toggleLabel: 'Sandbox terminal and file tools',
      toggleDescription:
        'Applies to every conversation in this profile. Existing host execution is stopped before a policy change completes; the next supported command uses the new policy.',
      shellNote: 'On first enable, Hermes downloads its managed shell unless you configured a custom shell.',
      workspaceRule:
        'Each conversation writes inside its user-selected project folder, shown in the composer, or the default Hermes workspace. Extra folders below are recursive grants. Runtime tools, private scratch, and supported pasted attachments have narrowly scoped internal access.',
      foldersTitle: 'Additional folders',
      isolationRule:
        'Supported commands cannot use the host clipboard, registry, or other processes. Only selected runtime environment variables are passed in; host credentials are excluded.',
      foldersEmpty: 'No additional user folder grants.',
      ...
      networkDescription:
        'Controls sandbox egress and web search/extraction. Browser automation, desktop control, MCP, connectors, generation, and execute_code remain refused even when networking is on. Host inference and trusted bookkeeping are outside this switch.',
  ...
  composer: {
    ...
    sandbox: {
      heading: 'Sandbox (MXC)',
      titleOn: 'Turn off the sandbox for all conversations in this profile',
      titleOff: 'Turn on the sandbox for all conversations in this profile',
      unknown: 'Not confirmed',
      unavailable: 'Unavailable',
      on: 'On',
      off: 'Off',
      descriptionOn: folder =>
        `This profile uses MXC for supported terminal and file tools. This conversation works in ${folder}, with any additional recursive folder grants from Settings.`,
      descriptionOff: 'Turn the sandbox on to contain supported terminal and file tools for all conversations in this profile.',
      networkOn: 'Network access is allowed.',
      networkOff: 'Network access is off.',
      isolated: 'Uncontained tools stay blocked even with networking on. Host inference and fixed Hermes bookkeeping remain trusted services.',
  ...
  assistant: {
    ...
    tool: {
      ...
      sandboxRecursiveScope: path => `Includes all files and subfolders in ${path}. This grant applies to every conversation in this profile.`,
