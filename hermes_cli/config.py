...
# Every install-method / managed-system name that Nix owns, for
# is_nix_install_method / get_managed_update_command.
...
def get_managed_update_command() -> Optional[str]:
    ...
    if managed_system == "NixOS" or (managed_system or "").lower() in _NIX_MANAGED_SYSTEMS:
