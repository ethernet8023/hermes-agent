  ...
  mkStateScript =
    ...
    let
      ...
      homeDocumentTree = mkDocumentTree {
        inherit pkgs;
        documents = cfg.hermesHomeDocuments;
      };
    ...
    ''
      ...
      ${installDocuments homeDocumentTree hermesHome cfg.hermesHomeDocuments}
