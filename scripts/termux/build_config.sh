...
# Toolchain the sdist builds pin (enforced by pip before the build loop).
# pypi pins, not pm pins: pip owns this layer.
TOOLCHAIN_PINS=(setuptools==83.0.0 cython==3.3.0 pybind11==3.1.0 maturin==1.15.0)
