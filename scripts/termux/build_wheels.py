...
def import_gate(resolved: Path, wheelhouse: Path, build_set: list[str]) -> None:
    """Every NATIVE wheel we built must import (the py3-none-any
    wheels are PyPI bytes; OUR builds are what this
    gate exists to prove. Offline install, then import each module."""
...
def main() -> int:
    ...
    import_gate(resolved, wheelhouse, build_set)
