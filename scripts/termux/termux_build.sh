...
# [h] The container (root) wrote the wheels; normalize perms so the
# host runner can read them for the manifest.
chmod -R a+rX "$WHEELHOUSE"

# [i] Emit the manifest artifacts (host side: pure data over the results).
